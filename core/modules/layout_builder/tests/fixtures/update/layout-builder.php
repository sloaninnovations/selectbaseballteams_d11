...
// Add all layout_builder_update_last_removed() as existing updates.
require_once __DIR__ . '/../../../../layout_builder/layout_builder.install';
$connection->merge('key_value')
  ->fields(['value' => serialize(layout_builder_update_last_removed())])
