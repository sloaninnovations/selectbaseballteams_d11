...
class BatchTestCallbacks {
   ...
   */
  public function callback_1($id, $sleep, &$context): void {
    $batch_test_helper = new BatchTestHelper();
   ...
   */
  public function callback_2($start, $total, $sleep, &$context): void {
    $batch_test_helper = new BatchTestHelper();
   ...
   * Implements callback_batch_operation().
   */
  public function callback_5($id, $sleep, &$context): void {
    $batch_test_helper = new BatchTestHelper();
    // No-op, but ensure the batch takes a couple iterations.
    // Batch needs time to run for the test, so sleep a bit.
    usleep($sleep);
   ...
   * Performs a simple batch operation.
   */
  public function callback_6($id, $sleep, &$context): void {
    $batch_test_helper = new BatchTestHelper();
    // No-op, but ensure the batch takes a couple iterations.
    // Batch needs time to run for the test, so sleep a bit.
    usleep($sleep);
   ...
   * Performs a simple batch operation.
   */
  public function callback_7($id, $sleep, &$context): void {
    $batch_test_helper = new BatchTestHelper();
    // No-op, but ensure the batch takes a couple iterations.
    // Batch needs time to run for the test, so sleep a bit.
    usleep($sleep);
   ...
   */
  public function finished_0($success, $results, $operations, $elapsed): void {
   ...
   */
  public function finished_2($success, $results, $operations, $elapsed): void {
   ...
   */
  public function finished_3($success, $results, $operations, $elapsed): void {
   ...
   */
  public function finished_4($success, $results, $operations, $elapsed): void {
   ...
   */
  public function finished_5($success, $results, $operations, $elapsed): void {
   ...
   */
  public function finished_6($success, $results, $operations, $elapsed): void {
   ...
   */
  public function finished_7($success, $results, $operations, $elapsed): void {
