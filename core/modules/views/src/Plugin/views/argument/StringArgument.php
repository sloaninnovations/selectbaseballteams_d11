...
class StringArgument extends ArgumentPluginBase {
  ...
  /**
   * Transforms and formats the argument value for display in the summary.
   *
   * @param object $data
   *   The data object containing the argument to be transformed.
   *
   * @return string
   *   The transformed and formatted argument value.
   */
