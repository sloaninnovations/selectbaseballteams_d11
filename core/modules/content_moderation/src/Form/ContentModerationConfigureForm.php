...
class ContentModerationConfigureForm extends WorkflowTypeConfigureFormBase implements ContainerInjectionInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['workflow_settings']['default_moderation_state'] = [
      ...
      '#type' => 'select',
      '#required' => TRUE,
      '#options' => ['' => $this->t('- Select moderation state -')] + array_map([State::class, 'labelCallback'], $this->workflowType->getStates()),
      ...
      '#default_value' => $workflow_type_configuration['default_moderation_state'] ?? '',
    ];
    return $form;
  }
