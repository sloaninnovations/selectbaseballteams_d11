    ...
    foreach ($fields as $field_name => $detail) {
      ...
      if ($commenting_status != CommentItemInterface::HIDDEN) {
        ...
        if ($view_mode == 'teaser') {
          ...
          if ($field->comment_count > 0 && $field->access('view comments only', $this->currentUser)) {
          ...
          if ($commenting_status == CommentItemInterface::OPEN) {
            ...
            if ($field->access('create', $this->currentUser)) {
              ...
              $existing_comments = $field->comment_count > 0 && $field->access('view comments only', $this->currentUser);
