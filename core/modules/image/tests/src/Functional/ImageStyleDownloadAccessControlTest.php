...
class ImageStyleDownloadAccessControlTest extends BrowserTestBase {
  ...
  public function testPrivateThroughPublicRoute(): void {
    $this->fileSystem->copy($this->root . '/core/tests/fixtures/files/image-1.png', 'private://image.png');
  ...
  public function testPublicThroughPrivateRoute(): void {
    $this->fileSystem->copy($this->root . '/core/tests/fixtures/files/image-1.png', 'public://image.png');
