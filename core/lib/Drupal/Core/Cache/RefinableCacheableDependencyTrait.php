...
trait RefinableCacheableDependencyTrait {
  ...
  public function addCacheableDependency($other_object) {
    if ($other_object instanceof CacheableDependencyInterface) {
      ...
      @trigger_error(sprintf("Calling %s() with an object that doesn't implement %s is deprecated in drupal:10.3.0 and is required in drupal:12.0.0. See https://www.drupal.org/node/3232020", __METHOD__, CacheableDependencyInterface::class), E_USER_DEPRECATED);
      $this->cacheMaxAge = 0;
    }
    return $this;
  }
