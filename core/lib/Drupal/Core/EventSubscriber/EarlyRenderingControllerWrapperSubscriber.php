...
use Drupal\Core\Routing\ControllerWrapper;
...
class EarlyRenderingControllerWrapperSubscriber implements EventSubscriberInterface {
  ...
  public function onController(ControllerEvent $event) {
    ...
    $event->setController([new ControllerWrapper($this->renderer, $controller, $arguments), 'wrapControllerExecutionInRenderContext']);
  }
