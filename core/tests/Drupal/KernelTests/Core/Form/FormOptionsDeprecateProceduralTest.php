...
class FormOptionsDeprecateProceduralTest extends KernelTestBase {
  ...
  public function testDeprecateGetOptions() {
    ...
    $this->expectDeprecation('form_get_options() is deprecated in drupal:10.3.0 and is removed from drupal:12.0.0. Use \Drupal\Core\Form\FormOptionsHelper::formGetOptions(). See https://www.drupal.org/node/3412600');
    $element = [
      '#type' => 'select',
  ...
  public function testDeprecateSelectOptions() {
    $this->expectDeprecation('form_select_options() is deprecated in drupal:10.3.0 and is removed from drupal:12.0.0. Use \Drupal\Core\Form\FormOptionsHelper::formSelectOptions(). See https://www.drupal.org/node/3412600');
