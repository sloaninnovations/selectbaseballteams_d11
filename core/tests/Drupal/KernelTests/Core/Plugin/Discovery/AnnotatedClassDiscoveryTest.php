...
class AnnotatedClassDiscoveryTest extends DiscoveryTestBase {
  ...
  protected function setUp(): void {
    ...
    $base_directory = 'core/modules/system/tests/modules/plugin_test/src';
    $base_directory2 = 'core/modules/system/tests/modules/plugin_test_extended/src';
    $namespaces = new \ArrayObject(['Drupal\plugin_test' => $base_directory, 'Drupal\plugin_test_extended' => $base_directory2]);

    // Ensure discovery works even if we are in the wrong directory.
    chdir('core');
