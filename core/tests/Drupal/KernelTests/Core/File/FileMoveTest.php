...
class FileMoveTest extends FileTestBase {
  ...
  public function testNormal(): void {
    ...
    $new_filepath = $this->fileSystem->move($uri, $desired_filepath, FileExists::Error);
    ...
    $newer_filepath = $this->fileSystem->move($new_filepath, $desired_filepath, FileExists::Rename);
  ...
  public function testMissing(): void {
    ...
    $this->fileSystem->move($this->randomMachineName(), $this->randomMachineName());
  }
  ...
  public function testOverwriteSelf(): void {
    ...
    $new_filepath = $this->fileSystem->move($uri, $uri, FileExists::Replace);
    $this->assertFalse($new_filepath, 'Moving onto itself without renaming fails.');
    $this->assertFileExists($uri);

    // Move the file onto itself with renaming will result in a new filename.
    $new_filepath = $this->fileSystem->move($uri, $uri, FileExists::Rename);
  ...
  public function testNotReadable(): void {
    ...
    $this->fileSystem->move($uri, $this->randomMachineName());
  }
