...
class ModuleHandlerTest extends UnitTestCase {
  ...
  public function testGroupIncludes(): void {
    ...
    $this->expectDeprecation('Autoloading hook include files vfs://drupal_root/test_module.tokens.inc is deprecated in drupal:11.2.0 and is removed from drupal:12.0.0. Move the functions in this file to either the .module file or other appropriate location. See https://www.drupal.org/node/3489765');
